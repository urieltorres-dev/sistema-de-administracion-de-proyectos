    ...
    <div class="flex flex-1  flex-col md:flex-row lg:flex-row mx-2">
        <div class="mb-2 border-solid border-gray-300 rounded border shadow-sm w-full">
            ...
            <div class="p-3">
                ...
                <form action="{{route('projects.update', $proyect)}}" class="w-full update-form" method="POST" novalidate>
                    @csrf
                    @method('PUT')
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full md:w-1/2 px-3 md:mb-0">
                            ...
                            @error('name')
                                border-red-500
                            @enderror"
                            value="{{$proyect->name}}"  id="name" name="name" type="text" placeholder="Nombre" required>
                            @error('name')
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            @error('lastname')
                                border-red-500
                            @enderror"
                            value="{{$collaborator->lastname}}"  id="lastname" name="lastname" type="text" placeholder="Apellido" required>
                            @error('lastname')
                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">
                                    {{$message}}
                                </p>
                        ...
                        <div class="w-full md:w-1/2 px-3 md:mb-0">
                            ...
                            @error('email')
                                border-red-500
                            @enderror"
                            value="{{$collaborator->email}}"  id="email" name="email" type="email" placeholder="Correo electrónico" required>
                            @error('email')
                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">
                                    {{$message}}
                                </p>
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            @error('phone')
                                border-red-500
                            @enderror"
                            value="{{$collaborator->phone}}"  id="phone" name="phone" type="tel" pattern="[0-9]{10}" placeholder="Numero de teléfono" required>
                            @error('phone')
                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">
                                    {{$message}}
                                </p>
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            @error('job')
                                border-red-500
                            @enderror"
                            value="{{$collaborator->job}}"  id="job" name="job" type="text" placeholder="Puesto de trabajo" required>
                            @error('job')
                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">
                                    {{$message}}
                                </p>
                        ...
                        <div class="w-full md:w-1/2 px-3">
                            ...
                            @error('company')
                                border-red-500
                            @enderror"
                            value="{{$collaborator->company}}"  id="company" name="company" type="text" placeholder="Compañia" required>
                            @error('company')
                                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">
                                    {{$message}}
                                </p>
